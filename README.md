...
- 👨‍💻 I have a keen interest in all things related to Science and Technology (definitely a nerd 🤓!), with a particular focus on Machine Learning, Computer Vision and Data Science. I am currently focused on my Master's thesis, working on the problem of UAV Absolute Visual Localization.

- 👨‍💻 I am currently working as a Machine Learning Researcher on the Vista-SL European Research Project, co-funded by Erasmus+. I am also employed at Algorithmics Greece -one of the largest educational organizations specializing in programming in Europe-, where I teach Python programming and AI to young students.
